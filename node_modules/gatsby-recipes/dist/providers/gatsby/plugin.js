...
const isDefaultExport = node => {
  ...
  if (property.type !== `Identifier` || property.name !== `exports`) return false;
  return true;
};
        ...
        visitor: {
          ExpressionStatement(path) {
            ...
            if (shouldAdd) {
              ...
              plugins.value.elements = plugins.value.elements.filter(node => getNameForPlugin(node) !== pluginOrThemeName);
            }
