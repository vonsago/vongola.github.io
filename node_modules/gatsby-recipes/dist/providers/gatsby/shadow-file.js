...
const create = async ({
  ...
  const fullFilePathToShadow = path.join(root, `node_modules`, theme, relativePathInTheme);
...
module.exports.plan = async ({
  ...
  const fullFilePathToShadow = path.join(root, `node_modules`, theme, `src`, path.join(...shadowPathParts));
